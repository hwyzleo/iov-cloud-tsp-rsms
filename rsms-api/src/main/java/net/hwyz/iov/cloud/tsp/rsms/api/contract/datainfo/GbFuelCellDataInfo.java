...
import net.hwyz.iov.cloud.tsp.rsms.api.contract.enums.GbDcDcState;
...
public class GbFuelCellDataInfo extends GbMessageDataInfo {
     ...
     * 高压DCDC状态
     */
    private GbDcDcState highPressureDcdcState;
    ...
    public int parse(byte[] dataInfoBytes) {
        ...
        this.highPressureDcdcState = GbDcDcState.valOf(dataInfoBytes[19 + temperatureProbeCount]);
    ...
    public byte[] toByteArray() {
        return ArrayUtil.addAll(new byte[]{this.dataInfoType.getCode()}, GbUtil.wordToBytes(this.voltage),
                ...
                new byte[]{this.hydrogenMaxPressureSensor}, new byte[]{this.highPressureDcdcState.getCode()});
    }
}
