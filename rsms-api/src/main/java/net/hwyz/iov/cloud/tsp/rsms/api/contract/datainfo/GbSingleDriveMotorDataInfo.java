...
import net.hwyz.iov.cloud.tsp.rsms.api.contract.enums.GbDriveMotorState;
...
public class GbSingleDriveMotorDataInfo extends GbMessageDataInfo {
     ...
     * 驱动电机状态
     */
    private GbDriveMotorState state;
    /**
     * 驱动电机控制器温度
    ...
    public int parse(byte[] dataInfoBytes) {
        ...
        this.state = GbDriveMotorState.valOf(dataInfoBytes[1]);
    ...
    public byte[] toByteArray() {
        return ArrayUtil.addAll(new byte[]{this.sn}, new byte[]{this.state.getCode()}, new byte[]{this.controllerTemperature},
