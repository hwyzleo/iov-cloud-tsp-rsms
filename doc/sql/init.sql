...
(
    ...
    `data_start_time`     TIMESTAMP             DEFAULT NULL COMMENT '数据开始时间',
    `data_end_time`       TIMESTAMP             DEFAULT NULL COMMENT '数据结束时间',
    `vehicle_count`       BIGINT                DEFAULT NULL COMMENT '车辆数',
    `vehicle_error_count` BIGINT                DEFAULT NULL COMMENT '错误车辆数',
    ...
    `message_count`       BIGINT                DEFAULT NULL COMMENT '消息总条数',
    `message_error_count` BIGINT                DEFAULT NULL COMMENT '错误消息条数',
